package com.wurple.presentation.flow.profile.edit.email.emailverification
...
import com.wurple.R
import com.wurple.databinding.FragmentEditProfileEmailEmailVerificationBinding
...
class EditProfileEmailEmailVerificationFragment :
    BaseViewModelFragment<EditProfileEmailEmailVerificationViewModel>(
        layoutResId = R.layout.fragment_edit_profile_email_email_verification
    ) {
    override val viewModel: EditProfileEmailEmailVerificationViewModel by baseViewModel()
    override val binding: FragmentEditProfileEmailEmailVerificationBinding by viewBinding()
    ...
    companion object {
        fun newInstance(): EditProfileEmailEmailVerificationFragment =
            EditProfileEmailEmailVerificationFragment()
    }
}